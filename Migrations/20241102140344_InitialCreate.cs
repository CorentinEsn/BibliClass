    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookTag", x => new { x.BooksISBN, x.TagsName });
                    table.ForeignKey(
                        name: "FK_BookTag_Books_BooksISBN",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    LoanerId = table.Column<int>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Loans", x => new { x.LoanerId, x.BookISBN });
                    table.ForeignKey(
